...
| `AB_APP_VERSION` | Application | `1.3.1` |
| `AB_AUTH_FAILURE_LIMIT` | Runtime guard | `20` |
| `AB_AUTH_FAILURE_WINDOW_SECONDS` | Runtime guard | `60` |
| `AB_BUILD_SHA` | Application | `None` |
| `AB_COMPUTE_ACQUIRE_TIMEOUT_MS` | Application | `50` |
| `AB_COMPUTE_ADMISSION_ENABLED` | Application | `True` |
| `AB_COMPUTE_MAX_CHEAP_CONCURRENT` | Application | `32` |
| `AB_COMPUTE_MAX_COST_UNITS_IN_FLIGHT` | Application | `250` |
| `AB_COMPUTE_MAX_HEAVY_CONCURRENT` | Application | `2` |
| `AB_COMPUTE_RETRY_AFTER_SECONDS` | Application | `2` |
...
| `AB_MAX_SLACK_BODY_BYTES` | Slack | `65_536` |
...
| `AB_SLACK_INVALID_SIGNATURE_LIMIT` | Slack | `20` |
| `AB_SLACK_INVALID_SIGNATURE_WINDOW_SECONDS` | Slack | `60` |
| `AB_SLACK_RATE_LIMIT_REQUESTS` | Slack | `60` |
| `AB_SLACK_RATE_LIMIT_WINDOW_SECONDS` | Slack | `60` |
