...
| `binary` | `normal_ppf`, `standard_normal_cdf`, `standard_normal_sf`, `wilson_score_interval`, `newcombe_difference_interval`, `calculate_detectable_mde_binary`, `calculate_binary_sample_size` | `app/backend/app/stats/binary.py` |
...
| `cuped` | `dot`, `quadratic_form`, `solve_linear_system`, `_pivoted_cholesky_indices`, `solve_psd_system`, `cuped_theta`, `adjusted_variance` | `app/backend/app/stats/cuped.py` |
...
| `sequential` | `_gauss_legendre_rule`, `_normal_density`, `_survival_state`, `_invert_spending_boundary`, `obrien_fleming_boundaries`, `sequential_sample_size_inflation` | `app/backend/app/stats/sequential.py` |
| `srm` | `chi_square_srm`, `chi_square_cdf`, `chi_square_sf`, `regularized_gamma_p`, `regularized_gamma_q`, `_gamma_series`, `_gamma_continued_fraction` | `app/backend/app/stats/srm.py` |
...
| `student_t` | `_betacf`, `_betainc_regularized`, `t_cdf`, `t_sf`, `f_sf`, `t_ppf` | `app/backend/app/stats/student_t.py` |
