...
BCG план (`BCG_plan.md` §1.1) требует закрытия конкретных сценариев. Нужно сверить существующие тесты с чек-листом и дописать недостающее БЕЗ изменения публичных контрактов хуков — это safety-net перед миграцией на Zustand.
