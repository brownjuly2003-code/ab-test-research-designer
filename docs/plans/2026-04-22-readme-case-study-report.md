...
Full inputs and outputs: [docs/case-studies/checkout-redesign.json](../case-studies/checkout-redesign.json). Rerun with `python scripts/generate_case_study_numbers.py`.
```
