    ...
    *,
    ...
    with sync_playwright() as playwright:
        ...
        try:
            ...
            page.get_by_role("heading", name="Plan your A/B experiment").wait_for(timeout=15000)
            page.get_by_text("AB Test Research Designer", exact=False).wait_for(timeout=15000)
