        ...
        <div className="result-block results-enter">
          ...
          <div className="metric-grid">
            <MetricCard
              ...
              subtitle={`${String(projectComparison.base_project.estimated_duration_days)} days`}
              meta={`${projectComparison.base_project.warning_severity} warning level`}
            ...
            <MetricCard
              ...
              subtitle={`${String(projectComparison.candidate_project.estimated_duration_days)} days`}
              meta={`${projectComparison.candidate_project.warning_severity} warning level`}
            ...
            <MetricCard
              ...
              subtitle="candidate vs base"
              meta={projectComparison.metric_alignment_note}
            />
            <MetricCard
              icon="warning"
              title="Warnings delta"
              value={formatDelta(projectComparison.deltas.warnings_count)}
              subtitle="candidate vs base"
              meta={`shared ${String(projectComparison.shared_warning_codes.length)}`}
          ...
          <div className="two-col">
            <div className="card">
              ...
              <ul className="list">
                ...
                <li>Executive summary: {projectComparison.base_project.executive_summary}</li>
            ...
            <div className="card">
              ...
              <ul className="list">
                ...
                <li>Executive summary: {projectComparison.candidate_project.executive_summary}</li>
            ...
            <div className="card">
              <strong>Comparison highlights</strong>
              <ul className="list">
            ...
            <div className="card">
              <strong>Assumptions overlap</strong>
              <ul className="list">
                <li>Shared: {projectComparison.shared_assumptions.join(", ") || "None"}</li>
                <li>Base only: {projectComparison.base_only_assumptions.join(", ") || "None"}</li>
                <li>Candidate only: {projectComparison.candidate_only_assumptions.join(", ") || "None"}</li>
              </ul>
            </div>
            <div className="card">
              <strong>Risk overlap</strong>
              <ul className="list">
                <li>Shared: {projectComparison.shared_risk_highlights.join(", ") || "None"}</li>
                <li>Base only: {projectComparison.base_only_risk_highlights.join(", ") || "None"}</li>
                <li>Candidate only: {projectComparison.candidate_only_risk_highlights.join(", ") || "None"}</li>
              </ul>
            </div>
            <div className="card">
              <strong>Recommendation highlights</strong>
              <ul className="list">
